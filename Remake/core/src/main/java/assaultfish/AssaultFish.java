...
//            moneyBag = "💰";//money bag
    ...
    private final LOS los = new LOS(LOS.BRESENHAM);
    ...
    private SparseLayers mapPanel, outputPanel, meterPanel, fishingViewPanel,
...
//        }
        prefs = Preferences.userNodeForPackage(AssaultFish.class);
